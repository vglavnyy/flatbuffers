...
inline const char *EnumNameRace(Race e) {
  if (e < Race::None || e > Race::Elf) return "";
...
inline const char *EnumNameAny(Any e) {
  if (e < Any::NONE || e > Any::MyGame_Example2_Monster) return "";
...
inline const char *EnumNameAnyUniqueAliases(AnyUniqueAliases e) {
  if (e < AnyUniqueAliases::NONE || e > AnyUniqueAliases::M2) return "";
  const size_t index = static_cast<size_t>(e);
...
inline const char *EnumNameAnyAmbiguousAliases(AnyAmbiguousAliases e) {
  if (e < AnyAmbiguousAliases::NONE || e > AnyAmbiguousAliases::M3) return "";
  const size_t index = static_cast<size_t>(e);
